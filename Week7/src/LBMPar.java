...
public class LBMPar extends Thread{

    final static int NITER = 30000 ;
    //final static int NITER = 5000 ;

    final static int P = 100;
    ...
    final static double Re = 300 ;  // Reynolds number
    ...
    public static <bool> void main(String args []) throws Exception {
        ...
        */
        ...
        LBMPar [] threads = new LBMPar [P] ;
        for(int me = 0 ; me < P ; me++) {
            threads [me] = new LBMPar(me) ;
            threads [me].start() ;
        }
    ...
    public void run(){
        for(int time = 0 ; time < NITER ; time++) {
            //if (Double.isNaN(fin[120][2][0])){System.out.println("BreakPoint");}
            
            long time1 = System.currentTimeMillis();
            
            if (me == 0){
                double max = fin[0][0][0];
