...
public class AirPar extends Thread{
    ...
    final static double ALPHA = -10 ;  // angle of attack in degrees
    ...
    public static void main(String args []) throws Exception {
        ...
        AirPar [] threads = new AirPar [P] ;
        for(int me = 0 ; me < P ; me++) {
            threads [me] = new AirPar(me) ;
            threads [me].start() ;
        }
...
*/
            ...
            if(time % OUTPUT_FREQ == 0 && me == 0) {
                ...
                System.out.println("Average lift = " +
                                   (- momYtoObstacle / time)) ;
                System.out.println("Average lift to drag ratio = " + ((- momYtoObstacle / time)/(momXtoObstacle / time)));
                display.repaint() ;
            }
        }
    }
